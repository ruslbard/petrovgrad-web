...
const feedbackData = [
    {code: 3, name: "Ирина", date: new Date(2019,3,17,19,36).toLocaleDateString(), link: "https://vk.com/topic-69056356_34972182?post=588#post588", text: "В декабре возникла идея купить комнату в конкретном районе и с конкретными параметрами. Поскольку приезжаю в Питер редко и ненадолго, хотела найти и оформить в кратчайшие сроки. Совсем случайно пообщалась на эту тему с Александром, который у меня в друзьях в контакте, но которого лично тогда не знала. Он предложил свою помощь в покупке. Уже в начале отметила его " +
            "энтузиазм и профессионализм в работе (контролирует малейшие детали при оформлении документов), чёткость действий и индивидуальный подход к клиенту, учитывая что я очень торопила события :) Всё прошло даже лучше, чем я предполагала, очень довольна результатом и продолжаю сотрудничать теперь с новым агентством Александра и, конечно, советую друзьям и знакомым."},
    {code: 2, name: "Станислава", date: new Date(2016,4,5,12,3).toLocaleDateString(), link: "https://vk.com/topic-69056356_34972182?post=293#post293", text: "В прошлом году наша семья решила наконец-то продать большую квартиру, и купить каждому отдельное жилье. Выставить квартиру на продажу самостоятельно мы побоялись, так как не знали, как правильно оформить сделку, боялись нарваться на мошенников, и просто слабо представляли реальную стоимость квартиры :) \n" +
    ...
    {code: 1, name: "Ксюша", date: new Date(2016,4,13,13,5).toLocaleDateString(), link: "https://vk.com/topic-67997335_33804109?post=158#post158",text: "Спасибо за хорошую работу) Обменяли 2 к.кв. на 3 к.кв. с доплатой на В.О., задача стояла не простая, потому как хотелось не менять даже микрорайон из-за привязки к школам и садам, плюс ипотека с участием материнского капитала! Теперь мы счастливые обладатели квартиры о которой мечтали) Рекомендую теперь всем друзьям и знакомым! Еще раз спасибо!!"},
    {code: 0, name: "Марина", date: new Date(2016,4,13,23,39).toLocaleDateString(), link: "https://vk.com/topic-67997335_33804109?post=159#post159", text: "Нам надо было продать 1к.кв. без ремонта. Мы обратились в «ПетровГрад». Его работой остались довольны. Все вопросы которые нас интересовали, нам разъяснили, нашли хороших покупателей и довольно таки быстро. Взяли на себя оформление всех документов, лишний раз нас не держали, были всегда на связи, если возникали вопросы. Спасибо."},
