...
const feedbackData = [
    ...
    {code: 3, name: "Ирина", date: new Date(2019,4,17,19,36).toLocaleDateString(), link: "https://vk.com/topic-69056356_34972182?post=588#post588", text: "В декабре возникла идея купить комнату в конкретном районе и с конкретными параметрами. Поскольку приезжаю в Питер редко и ненадолго, хотела найти и оформить в кратчайшие сроки. Совсем случайно пообщалась на эту тему с Александром, который у меня в друзьях в контакте, но которого лично тогда не знала. Он предложил свою помощь в покупке. Уже в начале отметила его " +
